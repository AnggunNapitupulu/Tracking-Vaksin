<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StatusRegistrasi.aspx.cs" Inherits="Vaksinku.StatusRegistrasi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="emergency-response-opt" class="em-standard">
        ...
        <div class="txt">
           ...
           <h4>Status Registrasi Vaksin anda saat ini : </h4>
           <span>                            
				Sudah Mendaftar
		   </span>
			<br />
